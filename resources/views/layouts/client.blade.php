...
<head>
  ...
  <script src="{{ asset('assets/js/kit-font-awesome.js') }}" crossorigin="anonymous"></script>
  <!-- Material Icons -->
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Round" rel="stylesheet">
  <!-- CSS Files -->
  <link id="pagestyle" href="{{ asset('assets/css/material-dashboard.css?v=3.0.4') }}" rel="stylesheet" />
  <link id="pagestyle" href="{{ asset('assets/css/font-awesome.css') }}" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-200">
  ...
  {{-- Aside --}}
  @include('layouts.include.student_aside')


  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    <!-- Navbar -->
    @include('layouts.include.student_nav')
