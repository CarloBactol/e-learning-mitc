            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-secondary shadow-secondary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Edit Department</h6>
                                ...
                                <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                                    ...
                                    <div class="input-group input-group-outline">
                                        ...
                                        <input type="text"
                                            ...
                                            name="department_name" onfocus="focused(this)" placeholder="Department"
                                            onfocusout="defocused(this)" value="{{ $department->department_name }}">
                            ...
                            <div class="col-lg-6">
                                <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                                    ...
                                    <div class="input-group input-group-outline">
                                        ...
                                        <input type="text"
                                            class="form-control @error('person_incharge') is-invalid @enderror"
                                            name="person_incharge" placeholder="Personal Incharge"
                                            onfocus="focused(this)" onfocusout="defocused(this)"
                                            value="{{ $department->person_incharge }}">
