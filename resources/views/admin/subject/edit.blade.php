            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-secondary shadow-secondary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Edit Subject </h6>
                    </div>
                </div>
                            ...
                            <div class="col-lg-6 mb-sm-2">
                                <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                                    ...
                                    <div class="input-group input-group-outline">
                                        ...
                                        <input type="text" value="{{ $subject->subject_code }}"
                            ...
                            <div class="col-lg-6 mb-sm-2">
                                <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                                    ...
                                    <div class="input-group input-group-outline">
                                        ...
                                        <input type="text" value="{{ $subject->number_of_units }}"
                                ...
                                <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                                    <div class="input-group input-group-outline">
                                        <textarea class="@error('description') form-control is-invalid @enderror"
                                            placeholder="Description" name="description" id="" cols="100">{!! $subject->description !!}
                                        </textarea>
                                        @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
