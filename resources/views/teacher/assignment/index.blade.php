        ...
        <div class="col-md-10" style="margin: 0 auto">
            <div class="card">
                <div class="card-header py-3 d-flex">
                    ...
                    <div class="ml-auto">
                        <a href="{{ route('teacher.teacher_assignments.create') }}" class="btn btn-primary">
                            <span class="icon text-white-50">
                                <i class="fa fa-plus"></i>
                            </span>
                            <span class="text">{{ __('New Assignment') }}</span>
                        </a>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <tr data-entry-id="{{ $item->id }}">
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('teacher.teacher_assignments.edit', $item->id) }}"
                                                class="btn btn-info px-4">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <form class="d-inline"
                                                action="{{ route('teacher.teacher_assignments.destroy', $item->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('delete')
