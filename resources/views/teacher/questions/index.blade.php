                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div
                            ...
                            <a href="{{ route('teacher.teacher_questions.create') }}" class="btn btn-primary mx-2">
                                    ...
                                    <tr data-entry-id="{{ $question->id }}">
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{ route('teacher.teacher_questions.edit', $question->id) }}"
                                                    class="btn btn-info px-4">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                                <form onclick="return confirm('are you sure ? ')" class="d-inline"
                                                    action="{{ route('teacher.teacher_questions.destroy', $question->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('delete')
